...
const MovieSearchApp = () => {
  ...
  useEffect(() => {
    async function featchData() {
        ...
        if (querysearch !== "") {
        const respones2 = await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=03353b943970dc693fa2f337d37459be&query='${querysearch}'`)
